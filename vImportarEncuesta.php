	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
	  ...
	  ?>
		...
		<? } else { ?>
		  ...
		  <td class="center lsmallT" style="width: 30px" nowrap>
		    <input type="text" required name="peso_<?echo $LISTA_PREGUNTA['Preg']['id_pregunta'][$i]?>" id="peso_<?echo $i?>" data-format="d.d" value="<?if ($LISTA_PREGUNTA['Preg']['peso'][$i]!=NULL) echo ($LISTA_PREGUNTA['Preg']['peso'][$i]*100); ?>" placeholder="0" maxLength="3" style="width: 30px;" />
		  </td>
		  </td> 		
		<? }?>
	      </tr>
