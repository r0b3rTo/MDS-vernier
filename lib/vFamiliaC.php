<?php
    session_start();
    $Legend = "Datos de Familia de Cargo";
    ...
    <div class="well" align="center">
        <form id="newOrg" class="form-horizontal" method="post" 
            ...
            <div class="control-group">
                <label class="control-label">Nombre de la Familia de Cargos</label>
                <div class="controls">
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-briefcase"></i></span>
                        <input type="text" class="input-xlarge" id="name" name="name" value="<? if(isset($_GET['id'])) echo $LISTA_ORG['Fc']['nombre']['0'];?>" placeholder="Familia de Cargos" <? if (isset($_GET['view'])) echo 'disabled' ?>>
                    </div>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                    ...
                    <div class="span9">
                    <p>
                    <a class="btn btn-info" href="vListarFamiliaC.php">Listar Familia de Cargos</a>
                    <?  if (isset($_GET['view'])) 
