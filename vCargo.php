<?php
    ...
    if (isset($_GET['id'])){
        ...
        include_once "lib/cVerCargo.php";
    }
...
?>
    <div class="well" align="center">
        <form id="newOrg" class="form-horizontal" method="post" 
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        ...
                        <input type="text" class="input-xlarge" id="name" name="name" value="<? if(isset($_GET['id'])) echo $_SESSION['CargoOne']['name']['0'];?>" placeholder="Cargo" <? if (isset($_GET['view'])) echo 'disabled' ?>>
                    </div>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label">Familia del Cargo</label>
                <div class="controls">
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-align-left"></i></span>
            ...
            <div class="control-group ">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        ...
                        <input type="text" class="input-xlarge" id="cod" name="cod" value="<? if(isset($_GET['id'])) echo $_SESSION['CargoOne']['cod']['0'];?>" placeholder="C&oacute;digo" <? if (isset($_GET['view'])) echo 'disabled' ?>>
                    </div>
                </div>
            </div>
            <div class="control-group ">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        ...
                        <textarea class="input-xlarge" rows="3" id="desc" name="desc" placeholder="Descripci&oacute;n" <? if (isset($_GET['view'])) echo 'disabled' ?>><? if(isset($_GET['id'])) echo $_SESSION['CargoOne']['desc']['0'];?></textarea>
                    </div>
                </div>
            </div>
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-prepend">
                        <span class="add-on"><i class="icon-edit"></i></span>
                        <textarea class="input-xlarge" rows="3" id="obs" name="obs" placeholder="Funciones"<? if (isset($_GET['view'])) echo 'disabled' ?>><? if(isset($_GET['id'])) echo $_SESSION['CargoOne']['obs']['0'];?></textarea>
                    </div>
                </div>
            </div>
