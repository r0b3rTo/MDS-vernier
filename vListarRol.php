  ...
  <div class="well" align="center">
    ...
    <div class="row">
      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
          ...
          <td class="center" nowrap><strong><?php echo $LISTA_ROL['Rol']['codigo'][$i]?></strong></td>
          <td class="center"><a <? echo "href='vRol.php?view&id=".$LISTA_ROL['Rol']['id'][$i]."'" ?>><? echo $LISTA_ROL['Rol']['nombre'][$i]?></a></td>
          <td class="center"><a <? echo "href='vOrganizacion.php?view&id=".$LISTA_ROL['Rol']['id_org'][$i]."'" ?>><? echo $ORG_ID[$LISTA_ROL['Rol']['id_org'][$i]]?></a></td>
      		<td class="center"><a <? echo "href='vFamiliaRol.php?view&id=".$LISTA_ROL['Rol']['id_fam'][$i]."'" ?>><? echo $FAM_ID[$LISTA_ROL['Rol']['id_fam'][$i]]?></a></td>
      		<td class="center" nowrap>
            <?
                echo "<a href='vRol.php?view&id=";
                echo $LISTA_ROL['Rol']['id'][$i]."' rel='tooltip' title='Detalles'><img src='img/iconos/edit-find.png' width='30' height='30' border=0 /></a> &nbsp;&nbsp;&nbsp;"; 
                echo "<a href='vRol.php?action=edit&id=";
                echo $LISTA_ROL['Rol']['id'][$i]."' rel='tooltip' title='Editar'><img src='img/iconos/edit-find-replace.png' width='30' height='30' border=0 /></a> &nbsp;&nbsp;&nbsp;"; 
                echo "<a href='vRol.php?action=copy&id=";
                echo $LISTA_ROL['Rol']['id'][$i]."' rel='tooltip' title='Copiar'><img src='img/iconos/edit-copy.png' width='30' height='30' border=0 /></a> &nbsp;&nbsp;&nbsp;"; 
                echo "<a data-toggle='modal' data-data='Sebuah Data' href='#confirm' data-url='lib/cRol.php?action=delete&id=";
                echo $LISTA_ROL['Rol']['id'][$i]."' rel='tooltip' title='Eliminar' onclick='return confirmar()'><img src='img/iconos/mail-mark-not-junk.png' width='30' height='30' border=0 /></a>&nbsp;&nbsp;&nbsp;"; 
            ?>
          </td>
      		</tr>
          <? } ?>     
