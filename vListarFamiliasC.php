...
<?php
  ...
  if ($LISTA_FC['max_res']==0){
      if(!isAdmin())
        echo "<br><br><br><br><br><br><p class='text-center text-info'>Hasta el momento no hay familia de cargo registrada.</p><br><br><br><br><br><br>";
      else
        echo "<br><br><br><br><br><br><p class='text-center text-info'>Hasta el momento no hay familia de cargo registrada.</p><br><br><br><br><br><br>";
  }else{
  ?>
  <div class="well span9 offset1">
    <?
      if (!isAdmin())
        echo "<div  align='center'><a href='vFamiliaC.php' class='btn btn-info'>Registrar Nueva</a></div>";
    ?>
    <div class="row">
      <div class="span9">
      ...
      <th class="lsmallT"><small>Acci&oacute;n</small></th>
          ...
          <td class="center lsmallT" nowrap>
            <?
                ...
                echo $LISTA_FC['Fc']['id'][$i]."' rel='tooltip' title='Editar'><img src='img/iconos/edit.gif' width='20' height='20' border=0 /></a> &nbsp;&nbsp;&nbsp;"; 
                echo "<a href='vFamiliaC.php?action=copy&id=";
                echo $LISTA_FC['Fc']['id'][$i]."' rel='tooltip' title='Copiar'><img src='img/iconos/edit-copy.png' width='20' height='20' border=0 /></a> &nbsp;&nbsp;&nbsp;"; 
                echo "<a data-toggle='modal' data-data='Sebuah Data' href='#confirm' data-url='lib/cFamiliaC.php?action=delete&id=";
                echo $LISTA_FC['Fc']['id'][$i]."' rel='tooltip' title='Eliminar' onclick='return confirmar()'><img src='img/iconos/eliminar.gif'/></a>&nbsp;&nbsp;&nbsp;"; 
            ?>
          </td>
          </tr>
          <? } ?>     
